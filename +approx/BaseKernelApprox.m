classdef BaseKernelApprox < approx.BaseApprox & dscomponents.AKernelCoreFun
...
%         function K = evaluateAtCenters(this, x1, t1, mu1, x2, t2, mu2)
...
%             % subsequent calls to evaluateAtCenters with the same
