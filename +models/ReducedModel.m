classdef ReducedModel < models.BaseModel
    %REDUCEDMODEL A KerMor reduced model
    %   In difference to the BaseModels this class cannot be extended. All
    %   needed functionality for reduced models is included here
    %   (simulation, error computation etc) and no specific subclasses for
    %   other models need to be implemented. One can obtain a reduced model
    %   from a full model by calling the full model's @code
    %   buildReducedModel @endcode function. Dont forget to call @code
    %   offlineGenerations @endcode at least once before reduction.
    %
